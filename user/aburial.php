                ...
                <div class="col-md-12">
                    ...
                    <div class="card-body">
                        ...
                        if ($user_rank == 'normal') {
                            ...
                            $query = mysqli_query($con, "SELECT * FROM burial WHERE uname = '$uname' AND status='1'");
                        } elseif ($user_rank == 'superadmin') {
                            // Check if the status column exists
                            $check_column = mysqli_query($con, "SHOW COLUMNS FROM burial LIKE 'status'");
                            if(mysqli_num_rows($check_column) > 0) {
                            $query = mysqli_query($con, "SELECT * FROM burial WHERE status='1'");
                            } else {
                            ...
                            <tr>
                                ...
                                <td width="7%">
                                    <div class="custom-dropdown">
                                            ...
                                            <?php if ($user_rank == 'superadmin' && $status == 1): ?>
