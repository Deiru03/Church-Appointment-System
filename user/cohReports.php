    ...
    <div class="row">
        ...
        <div class="content-wrapper">
            <div class="page-title">
                ...
                <p class="lead text-muted mb-4">View and manage Car/House baptismal reports that have been approved or declined.</p>
                    ...
                    <div class="table-responsive">
                        <table class="table table-hover table-bordered">
                            ...
                            <tbody>
                                ...
                                $query_str = "SELECT * FROM coh WHERE bapstatus IN ('1', '2')";
                                if ($start_date && $end_date) {
                                    $query_str .= " AND date BETWEEN '$start_date' AND '$end_date'";
                                }
